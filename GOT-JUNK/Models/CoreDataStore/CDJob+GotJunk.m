...
+(CDJob*) job:(Job *)job inManagedObjectContext:(NSManagedObjectContext*)context
{
    ...
    cdjob.comments = [job.comments isKindOfClass:[NSString class]] ? job.comments : nil;
    cdjob.contactCell = [job.contactCell isKindOfClass:[NSString class]] ? job.contactCell : nil;
    cdjob.contactCellAreaCode = [job.contactCellAreaCode isKindOfClass:[NSString class]] ? job.contactCellAreaCode : nil;
    cdjob.contactCellExt = [job.contactCellExt isKindOfClass:[NSString class]] ? job.contactCellExt : nil;
    cdjob.contactFax = [job.contactFax isKindOfClass:[NSString class]] ? job.contactFax : nil;
    cdjob.contactFaxAreaCode = [job.contactFaxAreaCode isKindOfClass:[NSString class]] ? job.contactFaxAreaCode : nil;
    cdjob.contactFaxExt = [job.contactFaxExt isKindOfClass:[NSString class]] ? job.contactFaxExt : nil;
    cdjob.contactHomeAreaCode = [job.contactHomeAreaCode isKindOfClass:[NSString class]] ? job.contactHomeAreaCode : nil;
    cdjob.contactHomeExt = [job.contactHomeExt isKindOfClass:[NSString class]]? job.contactHomeExt : nil;
    cdjob.contactHomePhone = [job.contactHomePhone isKindOfClass:[NSString class]] ? job.contactHomePhone : nil;
    cdjob.contactID = job.contactID; // no null value
    cdjob.contactPagerAreaCode = [job.contactPagerAreaCode isKindOfClass:[NSString class]] ? job.contactPagerAreaCode : nil;
    cdjob.contactPagerExt = [job.contactPagerExt isKindOfClass:[NSString class]] ? job.contactPagerExt : nil;
    cdjob.contactPagerPhone = [job.contactPagerPhone isKindOfClass:[NSString class]] ? job.contactPagerPhone : nil;
    cdjob.contactPhonePref = [job.contactPhonePref isKindOfClass:[NSString class]] ? job.contactPhonePref : nil;
    cdjob.contactPhonePrefID = job.contactPhonePrefID; // no null value
    cdjob.contactWorkAreaCode = [job.contactWorkAreaCode isKindOfClass:[NSString class]] ? job.contactWorkAreaCode : nil;
    cdjob.contactWorkExt = [job.contactWorkExt isKindOfClass:[NSString class]] ? job.contactWorkExt : nil;
    cdjob.contactWorkPhone = [job.contactWorkPhone isKindOfClass:[NSString class]] ? job.contactWorkPhone : nil;
    ...
    cdjob.dispatchMessage = [job.dispatchMessage isKindOfClass:[NSString class]] ? job.dispatchMessage : nil;
    cdjob.invoiceNumber = [cdjob.invoiceNumber isKindOfClass:[NSString class]] ? job.invoiceNumber : nil;
    ...
    cdjob.jobComments = [job.jobComments isKindOfClass:[NSString class]]? job.jobComments : nil;
    cdjob.jobDate = job.jobDate; // no null value
    cdjob.jobDuration = [NSNumber numberWithInt:[job.jobDuration integerValue]]; // Guranteed to be NSString
    cdjob.jobEndTime = [job.jobEndTime isKindOfClass:[NSString class]] ? job.jobEndTime : nil;
    cdjob.jobStartTime = [job.jobStartTime isKindOfClass:[NSString class]] ? job.jobStartTime : nil;
    ...
    cdjob.junkLocationComments = [job.junkLocationComments isKindOfClass:[NSString class]] ? job.junkLocationComments : nil;
    cdjob.nameOfLastTTUsed = [job.nameOfLastTTUsed isKindOfClass:[NSString class]] ? job.nameOfLastTTUsed : nil;
    cdjob.npsComment = [job.npsComment isKindOfClass:[NSString class]]? job.npsComment : nil;
    cdjob.npsValue = job.npsValue; // no null value
    cdjob.numOfJobs = job.numOfJobs; // no null value
    cdjob.onSiteContactAreaCode = [job.onSiteContactAreaCode isKindOfClass:[NSString class]] ? job.onSiteContactAreaCode : nil;
    cdjob.onSiteContactExt = [cdjob.onSiteContactExt isKindOfClass:[NSString class]] ? job.onSiteContactExt : nil;
    cdjob.onSiteContactID = [job.onSiteContactID isKindOfClass:[NSNumber class]]? job.onSiteContactID : [NSNumber numberWithInt:0];
    cdjob.onSiteContactPhone = [job.onSiteContactPhone isKindOfClass:[NSString class]]? job.onSiteContactPhone : nil;
    cdjob.onSiteContactPhonePref = [job.onSiteContactPhonePref isKindOfClass:[NSString class]]? job.onSiteContactPhonePref : nil;
    ...
    cdjob.pickupAddress = [job.pickupAddress isKindOfClass:[NSString class]] ? job.pickupAddress :nil;
    cdjob.pickupCompany = [cdjob.pickupCompany isKindOfClass:[NSString class]]? job.pickupCompany : nil;
    cdjob.pickupCountry = [job.pickupCountry isKindOfClass:[NSString class]]? job.pickupCountry : nil;
    cdjob.programDiscount = job.programDiscount; // no null value
    cdjob.programDiscountType = [job.programDiscountType isKindOfClass:[NSString class]]? job.programDiscountType : nil;
    cdjob.programNotes = [job.programNotes isKindOfClass:[NSString class]] ? job.programNotes : nil;
    cdjob.promiseTime = [job.promiseTime isKindOfClass:[NSString class]]? job.promiseTime : nil;
    cdjob.promoCode = [job.promoCode isKindOfClass:[NSString class]]? job.promoCode : nil;
    cdjob.subTotal = job.subTotal; // no null value
    cdjob.taxAmount = job.taxAmount; // no null value
    cdjob.taxID = job.taxID; // no null value
    cdjob.taxType = [job.taxType isKindOfClass:[NSString class]]? job.taxType : nil;
    ...
    cdjob.zipCode = [job.zipCode isKindOfClass:[NSString class]]? job.zipCode : nil;
    cdjob.zoneColor = [job.zoneColor isKindOfClass:[NSString class]]?job.zoneColor : nil;
    cdjob.zoneFontColor =[job.zoneFontColor isKindOfClass:[NSString class]]? job.zoneFontColor : nil;
    cdjob.zoneName = [job.zoneName isKindOfClass:[NSString class]]?job.zoneName :nil;
